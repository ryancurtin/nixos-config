...
let name = "Ryan Curtin";
    user = "ryancurtin";
    email = "rcurtin88@gmail.com"; in
{
  ...
  zsh = {
    ...
    initExtraFirst = ''
      ...
      HELPDIR="/nix/store/b3fsf6mk6qiwz4a1byvgvgwzcpn2glym-zsh-5.9/share/zsh/$ZSH_VERSION/help"
      ...
      alias gs='git status'
      alias gtl='git tag | sort --version-sort'
      ...
      alias rannotate='bundle exec annotate -i -k --exclude tests,fixtures'
      ...
      # Old install flags using `asdf` - no longer relevant in a nix world
      # export KERL_CONFIGURE_OPTIONS="--with-ssl=~/.nix-profile"
      # export CFLAGS="-O2 -g -I~/.nix-profile/include"
      # export LDFLAGS="-L~/.nix-profile/lib"
